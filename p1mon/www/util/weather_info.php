...
echo <<<"END"
				...
				<div id="weather" onMouseOver=show_weather_detail() class="weather_box display-none cursor-pointer">
				...
				<div class="cursor-pointer" id="weather_detail" onclick="$('#weather_detail').hide();">  
				...
				function show_weather_detail() {
					...
					$('#weather_detail').show();
					setTimeout( function() { $('#weather_detail').hide(); },10000);
				}
