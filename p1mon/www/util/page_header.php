...
function page_header() {
	...
	if  ( strlen( readStatusDb(66)) > 0 ) {
		...
		$newversion = '<a target="_blank" href="'. $download_url .'"><div title="'. $ttext . '" class="pos-42 content-wrapper"><span class="fa-layers fa-fw"><i class="fas fa-certificate color-warning fa-3x"></i><span class="fa-layers-text" data-fa-transform="right-13 shrink-6 rotate--30" style="font-weight:300">nieuwe versie</span></span></div></a>';
	}
